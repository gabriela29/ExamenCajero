...
public class RetirarL extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_retirar_l);
    ...
    private void regresarMenu(){
        Intent intent= new Intent(this, Secundarios.class);
...
// Set up the buttons
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_retirar_l, menu);
        return true;
    }
